...
@de_tools.route("/<project>/publication_groups")
@project_permission_required
...
@de_tools.route("/<project>/publication_group/<group_id>")
@project_permission_required
...
@de_tools.route("/<project>/publication_group/<group_id>/publications")
@project_permission_required
...
@de_tools.route("/<project>/publication/<publication_id>/add_group", methods=["POST"])
@project_permission_required
